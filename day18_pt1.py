...
for i in lines:
    allSnailfish = convertToList(i) if allSnailfish == None else add(allSnailfish, convertToList(i))
    reduce()

# This just ouputs the whole array of allSnailfish
print(" ".join([str(a) for a in allSnailfish]))

# This should print the magnitude of the string
print(magnitude())